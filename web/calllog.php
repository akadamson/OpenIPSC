...
while ( $Event = mysql_fetch_array( $Result ) ) {
    ...
    $Type=($Event[DataCall]==1)?"DATA":"VOICE";
    $UserCallsign=(is_null($Event[UserCallsign]))?"UNLISTED":$Event[UserCallsign];
    $UserName=(is_null($Event[UserName]))?"UNLISTED":$Event[UserName];
